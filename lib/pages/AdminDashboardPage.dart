...
class _AdminDashboardPageState extends State<AdminDashboardPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("📊 Admin Dashboard"), backgroundColor: Colors.indigo),
      body: Padding(
        ...
        child: Column(
          children: [
            Row(
              children: [
                _infoCard("Orders", orders.toString(), Icons.shopping_cart, Colors.blue),
                _infoCard("Users", users.toString(), Icons.people, Colors.orange),
                _infoCard("Sales", "₹${sales.toStringAsFixed(2)}", Icons.attach_money, Colors.green),
              ],
            ),
